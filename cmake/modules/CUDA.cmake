...
if(USE_CUDA)
  ...
  set(CUDA_REQUIRED_LIBS "")
  if(CUDA_NVRTC_LIBRARY)
    list(APPEND CUDA_REQUIRED_LIBS ${CUDA_NVRTC_LIBRARY})
  endif()
  if(CUDA_CUDART_LIBRARY)
    list(APPEND CUDA_REQUIRED_LIBS ${CUDA_CUDART_LIBRARY})
  endif()
  if(CUDA_CUDA_LIBRARY)
    list(APPEND CUDA_REQUIRED_LIBS ${CUDA_CUDA_LIBRARY})
  endif()
  
  # NVCUVID is optional for basic CUDA support
  if(NOT CUDA_NVCUVID_LIBRARY)
    message(WARNING "Cannot find libnvcuvid, NVDEC hardware acceleration will be disabled. You may need to manually register and download at https://developer.nvidia.com/nvidia-video-codec-sdk. Then copy libnvcuvid to cuda_toolkit_root/lib64/")
    set(NVDEC_SRCS "")
  else()
    file(GLOB NVDEC_SRCS src/video/nvcodec/*.cc)
    list(APPEND CUDA_REQUIRED_LIBS ${CUDA_NVCUVID_LIBRARY})
  endif()
